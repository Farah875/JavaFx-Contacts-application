 ...
 * this class is used when we are using the CSVView.fxml,
 * and the CSVParser class, so its for the usage of teh app with csv files
 * CSVController
 */
...
public class CSVController {
    ...
    public void readSearchFields ()  {
        ...
        String constraint = name+","+fName+","+birthday+","+gender+","+location+","+occupation+","+
                        ...
                        nameOrg+","+locationOrg+","+jobDescription+","+websiteType+","+websiteValue;
    ...
    public void addNewElement ()
    {
        ...
        ContactData contact = new ContactData();
        Contacts c = new Contacts(name, fName, birthday, gender,
                location,occupation,notes, group, e_mail);
